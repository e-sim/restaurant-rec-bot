...
const { RestaurantRecRecognizer } = require('./dialogs/recRecognizer');
...
// If configured, pass in the RestaurantRecognizer.  (Defining it externally allows it to be mocked for tests)
const { LuisAppId, LuisAPIKey, LuisAPIHostName } = process.env;
const luisConfig = { applicationId: LuisAppId, endpointKey: LuisAPIKey, endpoint: `https://${ LuisAPIHostName }` };

const luisRecognizer = new RestaurantRecRecognizer(luisConfig);
